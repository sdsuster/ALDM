...
brats_transforms = transforms.Compose(
    [
        ...
        transforms.SpatialPadd(keys=["t1", "t1ce", "t2", "flair"], spatial_size=(80, 80, 64), allow_missing_keys=True),
        transforms.Resized( keys=["t1", "t1ce", "t2", "flair"],
            spatial_size=(80, 80, 64),
            anti_aliasing=True, 
        ),
